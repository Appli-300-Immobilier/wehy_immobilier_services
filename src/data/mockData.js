// Catalogue de 100 biens pour Wehy immobilier services
...
export const MOCK_USERS_LIST = [
  ...
  { id: 'u3', name: 'Aubry Admin', email: 'admin@wehyimmobilierservices.cm', role: 'admin', status: 'Actif', joinDate: '01/01/2026' }
];
